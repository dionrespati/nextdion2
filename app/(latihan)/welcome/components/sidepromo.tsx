...
export default function Sidepromo() {
  return (
    <svg
      ...
      height="593"
      viewBox="0 0 400 593"
      className="w-[400px] flex-[0_0_400px]"
    >
      <defs>
      ...
      <g fill="none" fill-rule="evenodd">
        ...
        <g mask="url(#c)">
          <g fill-rule="nonzero" transform="translate(-192 211)">
            <use href="#e" fill="#000" filter="url(#d)" />
            <use href="#e" fill="#242742" />
          </g>
          <g transform="translate(-176 226)">
            <g fill-rule="nonzero">
              <use href="#g" fill="#000" filter="url(#f)" />
            ...
            <g fill-rule="nonzero">
              <use href="#i" fill="#000" filter="url(#j)" />
              <use href="#i" fill="url(#h)" />
            </g>
            <circle
              cx="390"
              cy="244"
          ...
          <g fill-rule="nonzero" transform="translate(129 115)">
            <use href="#n" fill="#000" filter="url(#m)" />
            <use href="#n" fill="url(#o)" />
            <path
              fill="url(#p)"
          ...
          <g transform="translate(246 93)">
            ...
            <use href="#q" fill="#FFF" fill-rule="nonzero" />
            <path
              fill="url(#r)"
              fill-rule="nonzero"
